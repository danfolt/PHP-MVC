...
class Users_Controller extends Controller
{
	public function __construct($app)
	{
		...
		$this->app->get_page()->set_path(array(
			...
			'index.php?route='.MODULE_NAME => 'User Management',
			));	

		$columns = array(
			array('db_name' => 'id',            'column_name' => 'Id',          'sorting' => 1),
			array('db_name' => 'user_login',    'column_name' => 'Login',       'sorting' => 1),
			array('db_name' => 'user_password', 'column_name' => 'Password',       'sorting' => 1),
			array('db_name' => 'user_name',     'column_name' => 'Name',        'sorting' => 1),
			array('db_name' => 'user_surname',  'column_name' => 'Surname',    'sorting' => 1),
			array('db_name' => 'email',         'column_name' => 'Email',      'sorting' => 1),
			array('db_name' => 'status',        'column_name' => 'Status',      'sorting' => 1),
			array('db_name' => 'registered',    'column_name' => 'Registered', 'sorting' => 1),
			array('db_name' => 'logged_in',     'column_name' => 'Logged in',   'sorting' => 1),
			array('db_name' => 'modified',      'column_name' => 'Modified', 'sorting' => 1),
			array('db_name' => 'logged_out',    'column_name' => 'Logged out', 'sorting' => 1),
			array('db_name' => 'active',        'column_name' => 'Active',     'sorting' => 1),
		);
