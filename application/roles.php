...
class Roles_Controller extends Controller
{
	public function __construct($app)
	{
		...
		$columns = array(
			...
			array('db_name' => 'user_name',   'column_name' => 'Full Name',        'sorting' => 1),
			array('db_name' => 'status',      'column_name' => 'Profile',           'sorting' => 1),
			array('db_name' => 'function',    'column_name' => 'Granted Functions', 'sorting' => 1),
		);
