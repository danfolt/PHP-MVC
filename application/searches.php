...
class Searches_Controller extends Controller
{
	public function __construct($app)
	{
		...
		$this->app->get_page()->set_path(array(
			'index.php' => 'Searches Management',
			'index.php?route=admin' => 'Admin Panel',
			'index.php?route='.MODULE_NAME => 'Searches',
			));	
		...
		$columns = array(
			...
			array('db_name' => 'search_text', 'column_name' => 'Searched Text', 'sorting' => 1),
			array('db_name' => 'search_time', 'column_name' => 'Searched Date',              'sorting' => 1),
		);
