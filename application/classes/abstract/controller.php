...
class Controller
{
	...
	public function AccessDenied()
	{
		...
		$this->app->get_page()->set_dialog(
			...
			array(
				array('link' => 'index.php?route=login', 'caption' => 'Login', 'onclick' => NULL),
				array('link' => 'index.php', 'caption' => 'Cancel', 'onclick' => NULL),
				)
			);
	...
	public function ConfirmDelete($id)
	{
		...
		$this->app->get_page()->set_dialog(
			MSG_QUESTION, 
			'Delete Record', 
			'Warning! You are going to permanently delete the record. <br />Are You sure?',
			array(
				array('link' => 'index.php?route='.MODULE_NAME.'&action=delete&id='.$id.'&confirm=yes', 'caption' => 'Yes', 'onclick' => NULL),
				array('link' => 'index.php?route='.MODULE_NAME, 'caption' => 'No', 'onclick' => NULL),
				)
			);
	...
	public function ConfirmReset()
	{
		...
		$this->app->get_page()->set_dialog(
			...
			array(
				array('link' => 'index.php?route='.MODULE_NAME.'&action=reset&confirm=yes', 'caption' => 'Yes', 'onclick' => NULL),
				array('link' => 'index.php?route='.MODULE_NAME, 'caption' => 'No', 'onclick' => NULL),
				)
			);
	...
	public function make_path($id)
	{
		...
		$this->path['index.php'] = 'Index Page';
