...
class Images_Controller extends Controller
{
	public function __construct($app)
	{
		...
		$this->app->get_page()->set_path(array(
			...
			'index.php?route='.MODULE_NAME => 'Gallery',
			));	
		
		$columns = array(
			array('db_name' => 'id',             'column_name' => 'Id',          'sorting' => 1),
			array('db_name' => 'preview',        'column_name' => 'Type',     'sorting' => 0),
			array('db_name' => 'file_format',    'column_name' => 'Format',      'sorting' => 1),
			array('db_name' => 'file_name',      'column_name' => 'Name',       'sorting' => 1),
			array('db_name' => 'file_size',      'column_name' => 'Size',     'sorting' => 1),
			array('db_name' => 'picture_width',  'column_name' => 'Width',   'sorting' => 1),
			array('db_name' => 'picture_height', 'column_name' => 'Height',    'sorting' => 1),
