...
class Users_View extends View
{
	...
	public function ShowList($columns, $data)
	{
		...
		$actions = array(
			...
			array('action' => 'setpass', 'icon' => 'access.png', 'title' => 'Password'),
	...
	public function ShowForm($data, $user)
	{
		...
		$form_title = $data ? 'Edit User' : 'New User';
		...
		$form_inputs = array(
			...
			array(
				...
				'data' => array(
					...
					'option' => array(
						array(
							'value' => '1', 'caption' => 'Administrators', $sel[1] => $sel[1],
							),
						array(
							'value' => '2', 'caption' => 'Operators', $sel[2] => $sel[2],
							),
						array(
							'value' => '3', 'caption' => 'Registered', $sel[3] => $sel[3],
							),
						), 
					),
				),
			array(
				...
				'data' => array(
					...
					'items' => array(
						...
						array(
							'id' => 'active_no', 'label' => 'Blocked', $chk[0] => $chk[0], 'value' => 0,
							),
						),
					),
				),
	...
	public function ShowPassword($id)
	{
		...
		$form_buttons = array(
			array(
				'type' => 'submit', 'id' => 'save_button', 'name' => 'save_button', 'value' => 'Save',
				),
			array(
