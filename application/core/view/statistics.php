		...
		$form_inputs = array(
			...
			array(
				...
				'data' => array(
					...
					'items' => array(
						array(
							'value' => 'Daily: <b>'.$data['day']['period_counter'].'</b>', 'style' => 'display: inline; margin: 5px;',
							),
						array(
							'value' => 'Weekly: <b>'.$data['week']['period_counter'].'</b>', 'style' => 'display: inline; margin: 5px;',
							),
						array(
							'value' => 'Monthly: <b>'.$data['month']['period_counter'].'</b>', 'style' => 'display: inline; margin: 5px;',
							),
						array(
							'value' => 'Narastający: <b>'.$data['all']['period_counter'].'</b>', 'style' => 'display: inline; margin: 5px;',
							),
						array(
							'value' => '<a href="/?route=statistics&mode=ip">Stats IP</a>', 'style' => 'display: inline; margin: 5px;',
							),
						),
					),
				),
			...
			array(
				...
				'data' => array(
					...
					'items' => array(
						...
						array(
							'value' => '<a href="/?route=statistics">Stats</a>', 'style' => 'display: inline; margin: 5px;',
							),
						),
					),
				),
