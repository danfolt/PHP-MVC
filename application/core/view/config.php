...
class Config_Controller extends Controller
{
	public function __construct($app)
	{
		...
		$this->app->get_page()->set_path(array(
			'index.php' => 'Config Page',
			'index.php?route=admin' => 'Admin Panel',
			'index.php?route='.MODULE_NAME => 'Configuration',
			));	
		
		$columns = array(
			array('db_name' => 'id',         'column_name' => 'Id',             'sorting' => 1),
			array('db_name' => 'key_name',   'column_name' => 'Key Name',   'sorting' => 1),
			array('db_name' => 'key_value',  'column_name' => 'Key value', 'sorting' => 1),
			array('db_name' => 'meaning',    'column_name' => 'Description',      'sorting' => 1),
