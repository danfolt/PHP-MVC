...
class Config_View extends View
{
	...
	public function ShowForm($data)
	{
		...
		$form_title = $data ? 'Edit key configuration' : 'New key configuration';
			...
			case 3:
				...
				$key_value_element = array(
					...
					'data' => array(
						...
						'items' => array(
							array(
								'id' => 'setting_yes', 'label' => 'Active (włączone)', $set[1] => $set[1], 'value' => 'true',
								),
							array(
								'id' => 'setting_no', 'label' => 'Unactive (wyłączone)', $set[0] => $set[0], 'value' => 'false',
								),
							),
						),
					);
		...
		$form_inputs = array(
			...
			array(
				...
				'data' => array(
					...
					'option' => array(
						array(
							'value' => '1', 'caption' => 'string (short text)', $sel[1] => $sel[1],
							),
						array(
							'value' => '2', 'caption' => 'area (text area - long text)', $sel[2] => $sel[2],
							),
						array(
							'value' => '3', 'caption' => 'option (true - false)', $sel[3] => $sel[3],
							),
						), 
					),
				),
			...
			array(
				...
				'data' => array(
					...
					'items' => array(
						array(
							'id' => 'active_yes', 'label' => 'Yes', $chk[1] => $chk[1], 'value' => 1,
							),
						array(
							'id' => 'active_no', 'label' => 'No', $chk[0] => $chk[0], 'value' => 0,
							),
						),
					),
				),
	...
	public function ShowDetails($data)
	{
		...
		$view_title = 'View Configuration Key';
