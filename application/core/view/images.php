...
class Images_View extends View
{
	...
	public function ShowList($columns, $data)
	{
		...
		$actions = array(
			array('action' => 'preview',  'icon' => 'picture.png', 'title' => 'Preview'),
			array('action' => 'view',     'icon' => 'info.png',    'title' => 'View'),
			array('action' => 'edit',     'icon' => 'edit.png',    'title' => 'Edit'),
			array('action' => 'download', 'icon' => 'save.png',    'title' => 'Download'),
	...
	public function ShowForm($data)
	{
		...
		$form_title = $data ? 'Edit photo' : 'New photo';
		...
		else // nowa pozycja
		{
			$form_buttons = array(
				array(
					'type' => 'submit', 'id' => 'upload_button', 'name' => 'upload_button', 'value' => 'Submit',
					),
				array(
					'type' => 'cancel', 'id' => 'cancel_button', 'name' => 'cancel_button', 'value' => 'Cancel',
					),
