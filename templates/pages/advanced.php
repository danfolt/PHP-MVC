    ...
    <div class="page-header">
      <form action="index.php?route=search" class="navbar-form navbar-right" role="search" method="post">
        <div class="form-group">
          <input type="text" name="text-search" class="form-control" placeholder="Search Article">
        </div>
        <button type="submit" name="button-search" class="btn btn-info"><i class="glyphicon glyphicon-search"></i> Search</button>
      </form>
      '.$this->get_links().'
