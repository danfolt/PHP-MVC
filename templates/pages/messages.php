...
class Messages_Controller extends Controller
{
	public function __construct($app)
	{
		...
		$this->app->get_page()->set_path(array(
			...
			'index.php?route='.MODULE_NAME => 'Email Messages',
			));	
		
		$columns = array(
			array('db_name' => 'id',              'column_name' => 'Id',                'sorting' => 1),
			array('db_name' => 'client_ip',       'column_name' => 'User IP',          'sorting' => 1),
			array('db_name' => 'client_name',     'column_name' => 'User Name', 'sorting' => 1),
			array('db_name' => 'client_email',    'column_name' => 'User e-mail',      'sorting' => 1),
			array('db_name' => 'message_content', 'column_name' => 'Message',  'sorting' => 1),
			array('db_name' => 'requested',       'column_name' => 'Requested',           'sorting' => 1),
			array('db_name' => 'send_date',       'column_name' => 'Send Date',           'sorting' => 1),
			array('db_name' => 'close_date',      'column_name' => 'Close Date',      'sorting' => 1),
		);
